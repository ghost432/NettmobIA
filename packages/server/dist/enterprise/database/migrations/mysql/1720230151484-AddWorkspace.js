...
class AddWorkspace1720230151484 {
    async up(queryRunner) {
        ...
        await (0, mysqlCustomFunctions_1.ensureColumnExists)(queryRunner, 'chat_flow', 'workspaceId', 'varchar(36)');
        await (0, mysqlCustomFunctions_1.ensureColumnExists)(queryRunner, 'tool', 'workspaceId', 'varchar(36)');
        await (0, mysqlCustomFunctions_1.ensureColumnExists)(queryRunner, 'assistant', 'workspaceId', 'varchar(36)');
        await (0, mysqlCustomFunctions_1.ensureColumnExists)(queryRunner, 'credential', 'workspaceId', 'varchar(36)');
        await (0, mysqlCustomFunctions_1.ensureColumnExists)(queryRunner, 'document_store', 'workspaceId', 'varchar(36)');
        await (0, mysqlCustomFunctions_1.ensureColumnExists)(queryRunner, 'evaluation', 'workspaceId', 'varchar(36)');
        await (0, mysqlCustomFunctions_1.ensureColumnExists)(queryRunner, 'evaluator', 'workspaceId', 'varchar(36)');
        await (0, mysqlCustomFunctions_1.ensureColumnExists)(queryRunner, 'dataset', 'workspaceId', 'varchar(36)');
        await (0, mysqlCustomFunctions_1.ensureColumnExists)(queryRunner, 'apikey', 'workspaceId', 'varchar(36)');
        await (0, mysqlCustomFunctions_1.ensureColumnExists)(queryRunner, 'variable', 'workspaceId', 'varchar(36)');
    }
