...
class AddSSOColumns1730519457880 {
    async up(queryRunner) {
        await (0, sqlliteCustomFunctions_1.ensureColumnExists)(queryRunner, 'organization', 'sso_config', 'text');
        await (0, sqlliteCustomFunctions_1.ensureColumnExists)(queryRunner, 'user', 'user_type', 'varchar');
        await (0, sqlliteCustomFunctions_1.ensureColumnExists)(queryRunner, 'login_activity', 'login_mode', 'varchar');
    }
