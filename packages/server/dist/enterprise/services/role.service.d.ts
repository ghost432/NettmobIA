...
export declare class RoleService {
    ...
    readRoleById(id: string | undefined, queryRunner: QueryRunner): Promise<Role>;
    ...
    readRoleByRoleIdOrganizationId(id: string | undefined, organizationId: string | undefined, queryRunner: QueryRunner): Promise<Role>;
    readGeneralRoleByName(name: string | undefined, queryRunner: QueryRunner): Promise<Role>;
    readRoleIsGeneral(id: string | undefined, queryRunner: QueryRunner): Promise<Role>;
