...
export declare class OrganizationService {
    ...
    readOrganizationById(id: string | undefined, queryRunner: QueryRunner): Promise<Organization>;
    validateOrganizationName(name: string | undefined, isRegister?: boolean): void;
    readOrganizationByName(name: string | undefined, queryRunner: QueryRunner): Promise<Organization>;
