...
export declare class UserService {
    ...
    readUserById(id: string | undefined, queryRunner: QueryRunner): Promise<User>;
    validateUserName(name: string | undefined): void;
    validateUserEmail(email: string | undefined): void;
    readUserByEmail(email: string | undefined, queryRunner: QueryRunner): Promise<User>;
    readUserByToken(token: string | undefined, queryRunner: QueryRunner): Promise<User>;
