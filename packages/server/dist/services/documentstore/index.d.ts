...
declare const _default: {
    ...
    getDocumentLoaders: () => Promise<any[]>;
    insertIntoVectorStoreMiddleware: (data: ICommonObject, isStrictSave: boolean, orgId: string, workspaceId: string, subscriptionId: string, usageCacheManager: UsageCacheManager) => Promise<any>;
    getEmbeddingProviders: () => Promise<any[]>;
    getVectorStoreProviders: () => Promise<any[]>;
    getRecordManagerProviders: () => Promise<any[]>;
    ...
    upsertDocStoreMiddleware: (storeId: string, data: IDocumentStoreUpsertData, files: Express.Multer.File[], orgId: string, workspaceId: string, subscriptionId: string, usageCacheManager: UsageCacheManager) => Promise<any>;
