...
const checkFlowValidation = async (flowId, workspaceId) => {
    try {
        ...
        if (!flow) {
            throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.NOT_FOUND, `Error: validationService.checkFlowValidation - flow not found!`);
        }
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: validationService.checkFlowValidation - ${(0, utils_1.getErrorMessage)(error)}`);
    }
};
exports.default = {
    checkFlowValidation
