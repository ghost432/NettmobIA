...
exports.Init1693891895163 = void 0;
class Init1693891895163 {
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS chat_flow (
        ...
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS chat_message (
                id uuid NOT NULL DEFAULT uuid_generate_v4(),
        ...
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS credential (
                id uuid NOT NULL DEFAULT uuid_generate_v4(),
                "name" varchar NOT NULL,
        ...
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS tool (
                id uuid NOT NULL DEFAULT uuid_generate_v4(),
                "name" varchar NOT NULL,
...
exports.Init1693891895163 = Init1693891895163;
