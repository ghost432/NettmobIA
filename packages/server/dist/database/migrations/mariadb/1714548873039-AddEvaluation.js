...
exports.AddEvaluation1714548873039 = void 0;
class AddEvaluation1714548873039 {
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS \`evaluation\` (
        ...
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS \`evaluation_run\` (
                \`id\` varchar(36) NOT NULL,
...
exports.AddEvaluation1714548873039 = AddEvaluation1714548873039;
