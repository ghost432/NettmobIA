...
exports.AddChatHistory1694657778173 = void 0;
class AddChatHistory1694657778173 {
    async up(queryRunner) {
        ...
        await queryRunner.query(`INSERT INTO "temp_chat_message" ("id", "role", "chatflowid", "content", "sourceDocuments", "createdDate", "chatId") SELECT "id", "role", "chatflowid", "content", "sourceDocuments", "createdDate", "chatId" FROM "chat_message";`);
...
exports.AddChatHistory1694657778173 = AddChatHistory1694657778173;
